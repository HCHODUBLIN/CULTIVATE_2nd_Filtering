...
RUN_DIR = "/Users/hyunjicho/Documents/CULTIVATE_2nd_Filtering/Run-03"
SOURCE_DIR = os.path.join(RUN_DIR, "01--to-process")                     # where the original *_results.xlsx live
SCRAPED_BASE = os.path.join(SOURCE_DIR, "_scraped_text")                 # where _scraped_text/<City>/scrape_summary.csv live
FILTER_CSV = os.path.join(RUN_DIR, "fsi_filter_results.csv")             # output from analyse_fsi_filter.py
OUTPUT_XLSX = os.path.join(RUN_DIR, "FSI_included_combined.xlsx")        # final combined Excel
OUTPUT_CSV = os.path.join(RUN_DIR, "FSI_included_combined.csv")          # optional CSV
